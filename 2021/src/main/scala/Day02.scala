package it.imolab.adventOfCode._2021.Day02

import scala.io.Source
import scala.util.matching.Regex

private val puzzle: List[String] = Source.fromFile("2021/src/main/resources/Day02.input.txt").getLines.toList
...
@main def answer_2 = println("2021 - Day 02 - answer 2: " + solve_2(puzzle))
